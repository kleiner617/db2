...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "db2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "db2 API";

        private String description = "db2 API documentation";
